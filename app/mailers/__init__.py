...
def send_email_raw(to_emails, subject, html_body,
    ...
    * `conn`: Use to send multiple messages in the same connection
    ...
    Usage:
    send_email_raw('user@example.com', 'Hey from app', 'this is the message',
                cc=['test@example.com'], reply_to='app@example.com')
    send_email_raw(['user@example.com'], 'Hey from app', 'this is the message',
                reply_to='app@example.com')
    """
...
class Mailer:
    ...
    DEFAULT_SUBJECT = "New Message from app"
