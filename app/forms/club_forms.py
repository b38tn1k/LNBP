...
class FacilitySetup(BaseForm):
    ...
    facility_type = SelectField('Facility Type', choices=[('Tennis Court', 'Tennis Court'), ('Pickle Ball Court', 'Pickle Ball Court'), ('Platform Tennis Court', 'Platform Tennis Court'), ('Squash Court', 'Squash Court') , ('Padel Court', 'Padel Court') , ('Racquet Ball Court', 'Racquet Ball Court')])
